 ...
 * @return array
 */
public function getDownloads(int $page = 1, int $perPage = 10): array {
  try {
    $offset = ($page - 1) * $perPage;

    // Fetch paginated results
    $query = "SELECT * FROM downloads LIMIT :limit OFFSET :offset;";
    ...
    $countStmt = $this->pdo->query("SELECT COUNT(*) as total FROM downloads;");
    ...
    throw new Exception("Error fetching paginated download list: " . $e->getMessage());
  }
}
